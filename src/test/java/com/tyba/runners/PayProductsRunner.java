...
@CucumberOptions(features = "src/test/resources/features/PayProducts.feature",
        glue = "com.tyba.stepdefinitions",
        snippets = SnippetType.CAMELCASE)
public class PayProductsRunner {

    public PayProductsRunner(){
    ...
    public static void test() throws IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/PayProducts.feature");
    }
}
